 ...
 *
 * <p>TransactionConfidence is updated via the {@link org.mvscoinj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link org.mvscoinj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link org.mvscoinj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link org.mvscoinj.core.TransactionConfidence#getConfidenceType()}
     ...
     * and so on. This information is useful for {@link org.mvscoinj.wallet.CoinSelector} implementations to risk analyze
