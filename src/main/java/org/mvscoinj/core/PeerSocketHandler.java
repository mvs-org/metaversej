...
import org.mvscoinj.net.AbstractTimeoutHandler;
import org.mvscoinj.net.MessageWriteTarget;
 ...
 * {@link org.mvscoinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
    ...
    private MvscoinSerializer.BitcoinPacketHeader header;
    ...
    public int receiveBytes(ByteBuffer buff) {
        checkArgument(buff.position() == 0 &&
                buff.capacity() >= MvscoinSerializer.BitcoinPacketHeader.HEADER_LENGTH + 4);
        try {
     ...
     * called automatically by {@link org.mvscoinj.net.NioClient} or
     * {@link org.mvscoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
