...
import org.mvscoinj.crypto.TransactionSignature;
...
import org.mvscoinj.utils.ExchangeRate;
...
import static org.mvscoinj.core.Utils.uint32ToByteStreamLE;
...
public class Transaction extends ChildMessage {
    ...
    /**
     * Used by MvscoinSerializer.  The serializer has to calculate a hash for checksumming so to
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.mvscoinj.script.Script, ECKey, org.mvscoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.mvscoinj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link org.mvscoinj.core.TxConfidenceTable}
