...
import org.mvscoinj.core.listeners.*;
import org.mvscoinj.net.ClientConnectionManager;
import org.mvscoinj.net.FilterMerger;
import org.mvscoinj.net.NioClientManager;
import org.mvscoinj.net.discovery.MultiplexingDiscovery;
import org.mvscoinj.net.discovery.PeerDiscovery;
import org.mvscoinj.net.discovery.PeerDiscoveryException;
import org.mvscoinj.script.Script;
import org.mvscoinj.utils.ContextPropagatingThreadFactory;
import org.mvscoinj.utils.ExponentialBackoff;
import org.mvscoinj.utils.ListenerRegistration;
import org.mvscoinj.utils.Threading;
import org.mvscoinj.wallet.Wallet;
import org.mvscoinj.wallet.listeners.KeyChainEventListener;
import org.mvscoinj.wallet.listeners.ScriptsChangeEventListener;
import org.mvscoinj.wallet.listeners.WalletCoinsReceivedEventListener;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of mvscoinj fixes the known
     ...
     * {@link org.mvscoinj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.mvscoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.mvscoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.mvscoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.mvscoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.mvscoinj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.mvscoinj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.mvscoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.mvscoinj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a mvscoinj based app running in SPV mode to fully validating security.
     */
