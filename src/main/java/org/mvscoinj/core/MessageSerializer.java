...
public abstract class MessageSerializer {
     ...
     */
    public abstract MvscoinSerializer.BitcoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException, UnsupportedOperationException;

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link MvscoinSerializer#deserializeHeader}.
     */
    public abstract Message deserializePayload(MvscoinSerializer.BitcoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException, UnsupportedOperationException;
