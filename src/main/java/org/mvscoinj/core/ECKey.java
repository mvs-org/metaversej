...
import org.mvscoin.NativeSecp256k1;
import org.mvscoin.NativeSecp256k1Util;
import org.mvscoin.Secp256k1Context;
import org.mvscoinj.crypto.*;
import org.mvscoinj.wallet.Protos;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.mvscoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link org.mvscoinj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link org.mvscoinj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * @throws org.mvscoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link org.mvscoinj.core.DumpedPrivateKey#toString()} method to get the string.
     *
