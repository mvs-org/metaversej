...
import org.mvscoinj.net.StreamConnection;
import org.mvscoinj.store.BlockStore;
import org.mvscoinj.store.BlockStoreException;
 ...
 * {@link org.mvscoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.mvscoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.mvscoinj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.mvscoinj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.mvscoinj.core.TxConfidenceTable}
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // mvscoinj is a client mode implementation. That means there's not much point in us talking to other client
     ...
     * Once the pong is received the value returned by {@link org.mvscoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.mvscoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.mvscoinj.core.Peer#ping()} has never
