...
public class BloomFilter extends Message {
     ...
     * See {@link org.mvscoinj.core.BloomFilter.BloomUpdate} for a brief description of each mode. The purpose
    ...
    /**
     * Returns true if this filter will match anything. See {@link org.mvscoinj.core.BloomFilter#setMatchAll()}
