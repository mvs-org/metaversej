...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.mvscoinj.store.SPVBlockStore} or you could also try a
     * {@link org.mvscoinj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
