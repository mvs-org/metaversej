...
import org.mvscoinj.net.discovery.HttpDiscovery;
import org.mvscoinj.params.*;
import org.mvscoinj.script.Script;
import org.mvscoinj.script.ScriptOpCodes;
import org.mvscoinj.store.BlockStore;
import org.mvscoinj.store.BlockStoreException;
import org.mvscoinj.utils.MonetaryFormat;
import org.mvscoinj.utils.VersionTally;
...
import static org.mvscoinj.core.Coin.COIN;
import static org.mvscoinj.core.Coin.FIFTY_COINS;
...
public abstract class NetworkParameters {
    ...
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.mvscoinj.unittest";
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.mvscoinj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.mvscoinj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.mvscoinj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.mvscoinj.core.AlertMessage}s. You can use {@link org.mvscoinj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
     ...
     */
    public abstract MvscoinSerializer getSerializer(boolean parseRetain);
