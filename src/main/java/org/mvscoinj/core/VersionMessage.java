...
public class VersionMessage extends Message {
    ...
    public static final String BITCOINJ_VERSION = "0.6.8";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/metaverse:" + BITCOINJ_VERSION + "/";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for mvscoinj
     * users might look like "/mvscoinj:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/mvscoinj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
