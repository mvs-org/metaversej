...
import org.mvscoinj.store.FullPrunedBlockStore;
 ...
 * {@link org.mvscoinj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with mvscoinj */
    ...
    /** Returns a checkpoints stream pointing to inside the mvscoinj JAR */
