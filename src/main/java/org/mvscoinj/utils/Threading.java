 ...
 * mvscoinj performs cycle detection or not. Cycle detection is useful to detect bugs but comes with a small cost.
...
public class Threading {
     ...
     * mvscoinj internally shouldn't normally run here, although currently there are a few exceptions.
     */
     ...
     * mvscoinj library code is run, setting it after you started network traffic and other forms of processing
    ...
    static {
        ...
        // instantiating any mvscoinj objects. The policy change will take effect only on new objects
