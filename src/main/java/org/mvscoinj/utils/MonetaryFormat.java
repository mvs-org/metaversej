...
import org.mvscoinj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable coin value to a {@link org.mvscoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.mvscoinj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
