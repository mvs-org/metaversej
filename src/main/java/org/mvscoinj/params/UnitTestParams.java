...
import org.mvscoinj.core.Block;

import java.math.BigInteger;

/**
 * Network parameters used by the mvscoinj unit tests (and potentially your own). This lets you solve a block using
 * {@link org.mvscoinj.core.Block#solve()} by setting difficulty to the easiest possible.
 */
public class UnitTestParams extends AbstractEtpNetParams {
