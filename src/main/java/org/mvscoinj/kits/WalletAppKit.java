...
import org.mvscoinj.core.listeners.DownloadProgressTracker;
import org.mvscoinj.net.discovery.DnsDiscovery;
import org.mvscoinj.net.discovery.PeerDiscovery;
import org.mvscoinj.protocols.channels.StoredPaymentChannelClientStates;
import org.mvscoinj.protocols.channels.StoredPaymentChannelServerStates;
import org.mvscoinj.store.BlockStore;
import org.mvscoinj.store.BlockStoreException;
import org.mvscoinj.store.SPVBlockStore;
import org.mvscoinj.wallet.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV mvscoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit mvscoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing mvscoinj
...
public class WalletAppKit extends AbstractIdleService {
    ...
    public WalletAppKit connectToLocalHost() {
        try {
            final InetAddress localHost = InetAddress.getByName("faucet.xeno-genesis.com");
     ...
     * block sync faster for new users - please refer to the documentation on the mvscoinj website
