...
package org.mvscoinj.uri;

import org.mvscoinj.core.Address;
import org.mvscoinj.core.AddressFormatException;
import org.mvscoinj.core.Coin;
import org.mvscoinj.core.NetworkParameters;
import org.mvscoinj.params.AbstractEtpNetParams;
...
public class BitcoinURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link AbstractEtpNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.mvscoinj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        String scheme = null == params
            ? AbstractEtpNetParams.BITCOIN_SCHEME
            : params.getUriScheme();
