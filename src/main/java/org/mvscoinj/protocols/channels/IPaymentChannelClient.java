...
package org.mvscoinj.protocols.channels;

import com.google.common.util.concurrent.ListenableFuture;
import com.google.protobuf.ByteString;
import org.mvscoin.paymentchannel.Protos;
import org.mvscoinj.core.Coin;
import org.mvscoinj.core.ECKey;
import org.mvscoinj.core.InsufficientMoneyException;
...
public interface IPaymentChannelClient {
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(org.mvscoinj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(org.mvscoinj.protocols.channels.PaymentChannelCloseException.CloseReason)}
    ...
    interface ClientConnection {
         ...
         * {@link org.mvscoinj.protocols.channels.PaymentChannelClient#connectionClosed()} should be called immediately. In the case of messages which
         ...
         *
         * <p>Called while holding a lock on the {@link org.mvscoinj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         */
         ...
         * {@link org.mvscoinj.protocols.channels.PaymentChannelClient#connectionClosed()} event should be generated immediately after this call.</p>
         *
         * <p>Called while holding a lock on the {@link org.mvscoinj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         *
         ...
         *               {@link org.mvscoinj.protocols.channels.PaymentChannelCloseException.CloseReason#CLIENT_REQUESTED_CLOSE} as "unrecoverable error" and all others as
         ...
         * will be closed with a  {@link org.mvscoinj.protocols.channels.PaymentChannelCloseException.CloseReason#TIME_WINDOW_UNACCEPTABLE}.</p>
         ...
         * {@link org.mvscoinj.protocols.channels.PaymentChannelClient#incrementPayment(Coin)}
         * may be called at will.</p>
         *
         * <p>Called while holding a lock on the {@link org.mvscoinj.protocols.channels.PaymentChannelClient}
    ...
    interface ClientChannelProperties {
         ...
         *  See {@link org.mvscoinj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
         *
         */
        long timeWindow();
