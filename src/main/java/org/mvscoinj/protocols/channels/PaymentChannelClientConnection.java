...
import org.mvscoinj.net.NioClient;
import org.mvscoinj.net.ProtobufConnection;
import org.mvscoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties;
...
public class PaymentChannelClientConnection {
     ...
     * {@link org.mvscoinj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
     ...
     * Attempts to open a new connection to and open a payment channel with the given host and port, blocking until the
     * connection is open.  The server is requested to keep the channel open for
     * {@link org.mvscoinj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW} seconds.
