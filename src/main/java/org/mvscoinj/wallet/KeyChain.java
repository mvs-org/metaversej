...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link org.mvscoinj.wallet.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the mvscoinj protobuf format. */
     ...
     *
     * <p>See the docs for {@link org.mvscoinj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
