...
import org.mvscoin.protocols.payments.Protos.*;
import org.mvscoinj.core.*;
import org.mvscoinj.core.TransactionConfidence.ConfidenceType;
import org.mvscoinj.core.TransactionConfidence.Listener;
import org.mvscoinj.core.listeners.NewBestBlockListener;
import org.mvscoinj.core.listeners.ReorganizeListener;
import org.mvscoinj.core.listeners.TransactionConfidenceEventListener;
import org.mvscoinj.core.listeners.TransactionReceivedInBlockListener;
import org.mvscoinj.crypto.*;
import org.mvscoinj.script.Script;
import org.mvscoinj.script.ScriptBuilder;
import org.mvscoinj.script.ScriptChunk;
import org.mvscoinj.signers.LocalTransactionSigner;
import org.mvscoinj.signers.MissingSigResolutionSigner;
import org.mvscoinj.signers.TransactionSigner;
import org.mvscoinj.utils.BaseTaggableObject;
import org.mvscoinj.utils.ListenerRegistration;
import org.mvscoinj.utils.Threading;
import org.mvscoinj.wallet.Protos.Wallet.EncryptionType;
import org.mvscoinj.wallet.WalletTransaction.Pool;
import org.mvscoinj.wallet.listeners.*;
 ...
 * {@link Wallet#autosaveToFile(File, long, TimeUnit, org.mvscoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.mvscoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.mvscoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.mvscoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.mvscoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.mvscoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.mvscoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.mvscoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.mvscoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.mvscoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.mvscoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.mvscoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.mvscoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.mvscoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of mvscoinj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(File, long, TimeUnit, org.mvscoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.mvscoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.mvscoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.mvscoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.mvscoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.mvscoinj.crypto.KeyCrypter,
     ...
     * {@link org.mvscoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.mvscoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.mvscoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.mvscoinj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.mvscoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.mvscoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
