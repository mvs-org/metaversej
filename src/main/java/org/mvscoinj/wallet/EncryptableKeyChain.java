...
import org.mvscoinj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.mvscoinj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.mvscoinj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.mvscoinj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
