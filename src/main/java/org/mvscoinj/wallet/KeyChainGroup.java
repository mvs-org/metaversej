...
/**
 * <p>A KeyChainGroup is used by the {@link org.mvscoinj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.mvscoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.mvscoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.mvscoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
