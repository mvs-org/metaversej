...
import org.mvscoinj.core.BloomFilter;
import org.mvscoinj.core.ECKey;
import org.mvscoinj.core.NetworkParameters;
import org.mvscoinj.core.Utils;
 ...
 * {@link org.mvscoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.mvscoinj.crypto.MnemonicCode},
 ...
 * {@link org.mvscoinj.crypto.DeterministicKey#serializePubB58(org.mvscoinj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.mvscoinj.crypto.DeterministicKey#deserializeB58(org.mvscoinj.crypto.DeterministicKey, String, org.mvscoinj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.mvscoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.mvscoinj.crypto.DeterministicHierarchy} and
 * {@link org.mvscoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from mvscoinj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.mvscoinj.crypto.DeterministicKey)}
     ...
     * @see org.mvscoinj.wallet.MarriedKeyChain
     */
