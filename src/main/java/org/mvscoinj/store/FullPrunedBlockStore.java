...
public interface FullPrunedBlockStore extends BlockStore, UTXOProvider {
    ...
    /**
     * Gets a {@link org.mvscoinj.core.UTXO} with the given hash and index, or null if none is found
     */
    UTXO getTransactionOutput(Sha256Hash hash, long index) throws BlockStoreException;
    
    /**
     * Adds a {@link org.mvscoinj.core.UTXO} to the list of unspent TransactionOutputs
     */
    void addUnspentTransactionOutput(UTXO out) throws BlockStoreException;
    
    /**
     * Removes a {@link org.mvscoinj.core.UTXO} from the list of unspent TransactionOutputs
