...
import static org.mvscoinj.core.Utils.HEX;
...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link org.mvscoinj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
     ...
     * in which case the time is stored alongside the key as per normal, see {@link org.mvscoinj.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
